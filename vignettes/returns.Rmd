...
```{r look-at-data, fig.height = 7, fig.width = 12, dev="svg"}
plot(returns)
```
...
```{r output2, fig.height=8, fig.width=14, dev="svg"}
...
```{r investigate-split, fig.align = "left", fig.height = 9, fig.width = 9, dpi = 144, out.width = "100%", include = FALSE, eval = FALSE}
